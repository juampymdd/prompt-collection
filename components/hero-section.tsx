      ...
      <div className="container mx-auto px-4 text-center relative z-10">
        ...
        >
          <p className="text-lg md:text-xl lg:text-2xl text-muted-foreground max-w-3xl mx-auto mb-12 text-pretty leading-relaxed">
            Coleccion curada de prompts para desarrollo, diseno, documentacion y
            mas.
            <span className="block mt-2 text-foreground/80">
              Copia, usa y transforma tu flujo de trabajo.
            </span>
          </p>
        </div>
        ...
        {/* Stats */}
        <div
          className="animate-fade-in-up opacity-0 mt-20"
          style={{ animationDelay: "600ms", animationFillMode: "forwards" }}
        >
          <div className="flex flex-wrap items-center justify-center gap-8 md:gap-16">
            {[
              { value: "10+", label: "Prompts" },
